...
static const std::tuple<UINT, const char*> D3D11_VIDEO_PROCESSOR_PROCESSOR_CAP_names[] = {
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_PROCESSOR_CAPS_DEINTERLACE_BLEND),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_PROCESSOR_CAPS_DEINTERLACE_BOB),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_PROCESSOR_CAPS_DEINTERLACE_ADAPTIVE),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_PROCESSOR_CAPS_DEINTERLACE_MOTION_COMPENSATION),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_PROCESSOR_CAPS_INVERSE_TELECINE),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_PROCESSOR_CAPS_FRAME_RATE_CONVERSION),
};

static const std::tuple<UINT, const char*> D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_names[] = {
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_32),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_22),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_2224),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_2332),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_32322),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_55),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_64),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_87),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_222222222223),
	DECL_TUPLE_A(D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_OTHER),
};
